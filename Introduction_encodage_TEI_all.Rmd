...
<ul style="list-style-type:upper-roman; text-align: justify; font-size: 14px">
<li>Module [namesdates] pour les noms, dates, personnes et lieux géographiques</li>
<li>Schéma d’entête <teiHeader></li>
...
Bauman, Syd, and Julia Flanders. 2010. <a href=https://wwp.northeastern.edu/outreach/seminars/uvic_advanced_2016/handouts/elementList_odd.xhtml" target="_blank"><i>Element list for ODD</i></a>.</p>
</p>
...
<hr style="border-style: dotted; border-color: #D3D3D3; margin-top: 50px; width: 250px;  margin-left: 0px" />
<p style="text-align: justify">Complément de lecture :<br>
Gerhard Budin, Stefan Majewski and Karlheinz Mörth, « Creating Lexical Resources in TEI P5 », <i>Journal of the Text Encoding Initiative</i> [Online], Issue 3 | November 2012. URL : <a href="https://journals.openedition.org/jtei/522" target="_blank">http://journals.openedition.org/jtei/522</a> ; DOI : 10.4000/jtei.522.</p>
<br>
