...
<ul style="list-style-type:upper-roman; text-align: justify; font-size: 14px">
<li><a href="#tei_modNamesdates">Module [namesdates] pour les noms, dates, personnes et lieux géographiques</a></li>
<li><a href="#tei_relationNœuds"><code>&#64;attribut</code>s pour créer une relation entre deux ou plusieurs nœuds</a></li>
<li><a href="#tei_teiCorpus">Encodage pour un corpus : <code>&lt;teiCorpus&gt;</code> du module [core] et <i>primary source</i></a></li>
</ul>
...
<ol>
  ...
  <li>nœuds d'espace de noms (<i>namespace</i>)
...
<ul>
  <li><u>Axes avant</u> :
    ...
    &#8702; <code>attribute::</code> : sélectionne tous les attributs du nœud courant ; ex. <code>attribute::&#64;type</code> <=> sélectionne l'attribut <code>&#64;type</code> du nœud courant &mdash; + en option sa <code>"valeur"</code>, ex.  <code>&#64;type="adv"</code> <=> sélectionne uniquement l'attribut <code>&#64;type</code> dont la valeur est “adv”.<br>
      ...
      &#8702; <code>namespace::</code> : sélectionne tous les nœuds des <code>namespaces</code> (espace de noms) du nœud courant</p>
  </li>  
  <li><u>Axes arrière</u> :
...
<br><br>
<hr style="padding-top: 20px; padding-bottom: 10px">
<h2 style="font-size: 20px; color: #808080;"><a id="tei_modNamesdates" style="color: #808080">6.I. Module [namesdates] pour les noms, dates, personnes et lieux géographiques</a></h2>


<hr style="padding-top: 20px; padding-bottom: 10px">
<h2 style="font-size: 20px; color: #808080;"><a id="tei_relationsNœuds" style="color: #808080">6.II. <code>&#64;attribut</code>s pour créer une relation entre deux ou plusieurs nœuds </h2>


<hr style="padding-top: 20px; padding-bottom: 10px">
<h2 style="font-size: 20px; color: #808080;"><a id="tei_teiCorpus" style="color: #808080">6.III. Encodage pour un corpus : <code>&lt;teiCorpus&gt;</code> du module [core] et <i>primary source</i></a> </h2>
...
<ul>
<li><code>teiCorpus</code> : </li>
<li><code>teiHeader</code> : </li>
<li><code>fsdDecl</code> : déclaration de système de traits relatives à une <i>structure de traits</i> (paire trait-valeur)</li>
...
<li><code>facsimile</code> : représentation d'une image d'une source écrite transcrite &mdash; relative au <i>Primary Source</i></li>
...
<hr style="padding-top: 20px; padding-bottom: 10px">
<h2 style="font-size: 20px; color: #808080;"><a id="xslt_intro" style="color: #808080">8.III. Brève introduction à <code>XSLT</code></a> </h2>
